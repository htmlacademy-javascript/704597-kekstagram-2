...
npm install
```
Если выдает ошибку, нужно ввести
```bash
npm install --legacy-peer-deps
```
Это проигнорирует конфликт и установит пакеты так, как это делал npm v6. Подходит, если нужно просто запустить проект сейчас.
